...
let szukane = "Fruits"
function getSumOfFruits(products,szukane){

    return products.filter(element => {
        return element.category.includes(szukane);

      });
}
console.log(`Suma produktów z szukanej kategori:${sumElements(getSumOfFruits(products3,szukane))}`)